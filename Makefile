...
#
# Generated on 2026-07-01T05:24:27Z by kres 7421bcd.
...
all: unit-tests talos-exporter image-talos-exporter lint
...
.PHONY: $(ARTIFACTS)/talos-exporter-linux-amd64
$(ARTIFACTS)/talos-exporter-linux-amd64:
	@$(MAKE) local-talos-exporter-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: talos-exporter-linux-amd64
talos-exporter-linux-amd64: $(ARTIFACTS)/talos-exporter-linux-amd64  ## Builds executable for talos-exporter-linux-amd64.

.PHONY: $(ARTIFACTS)/talos-exporter-linux-arm64
$(ARTIFACTS)/talos-exporter-linux-arm64:
	@$(MAKE) local-talos-exporter-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: talos-exporter-linux-arm64
talos-exporter-linux-arm64: $(ARTIFACTS)/talos-exporter-linux-arm64  ## Builds executable for talos-exporter-linux-arm64.

.PHONY: talos-exporter
talos-exporter: talos-exporter-linux-amd64 talos-exporter-linux-arm64  ## Builds executables for talos-exporter.
...
.PHONY: image-talos-exporter
image-talos-exporter:  ## Builds image for talos-exporter.
	@$(MAKE) registry-$@ IMAGE_NAME="talos-exporter"
